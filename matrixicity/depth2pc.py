...
def parse_args():
    ...
    parser.add_argument("--rgb_path",
                        type=str,
                        default='data/small_city_img/new_high/block_9/')
    
    parser.add_argument("--depth_path",
                        type=str,
                        default='data/small_city_img/new_high/block_9_depth')

    parser.add_argument("--json_path",
                        type=str,
                        default='data/small_city_img/new_high/block_9/transforms_train.json')
    
    parser.add_argument("--save_path",
                        type=str,
                        default='data/small_city_img/new_high/block_9/point_cloud')
...
if __name__ == '__main__':
    ...
    for i, frame in enumerate(frames):
        ...
        depth = cv2.imread(os.path.join(args.depth_path,file_path.split('/')[-1].replace("png","exr")), cv2.IMREAD_ANYCOLOR | cv2.IMREAD_ANYDEPTH)[...,0] / 10000. # cm -> 100m
